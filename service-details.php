...
<body>
			...
			<div class="row align-items-center">
				<div class="col-lg-2">
					<div class="Cat Shop-logo ">
						<a href="index.html" title="Cat Master"><img src="assets/images/main-thumb/cat-logo.png"  alt="logo"></a>
					</div>
				</div>
				<div class="col-lg-5">
					<nav class="header-menu ">
						<ul>
							<li><a href="#" class="active">Home <i class="fas fa-chevron-down"></i></a>
								<div class="submenu">
									<ul>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="banner-inner-link wow fadeInRight" data-wow-delay=".3s">
                        <ul>
                            ...
                            <li><a href="service-details.html"><i class="far fa-hand-point-right"></i>Service Details</a></li>
                        </ul>
                    </div>
                </div>
            </div>
	...
	<!--==================================================-->
	<!-- Start Cat Shop Service Details Section Here -->
	<!--==================================================-->
	<section class="services-details">
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
					<div class="services-details__content wow fadeInUp">
						<img src="assets/images/main-thumb/blog-list-thumb3.jpg" alt="thumb ">
						<h2 class="mt-4 wow fadeInUp animated">Cat Health And Cat Care Services.</h2>
						...
						<div id="tab1" class="tab_content wow fadeInLeft animated">
                            <ul class="accordion">
                                <li>
                                    <a><div class="accordion-title">01 &nbsp; You know you’re here for  of yourself and you’re ready for change! </div><div class="accordian-icon"><i class="bi bi-chevron-down"></i></div></a>
                                    <p class="wow fadeInRight animated">Authoritatively evisculate technically sound action items for 
                                    synergistic portals. Intrinsicly synthesize inexpensive experi
                                    ences rather than cross-unit .</p>
                                </li>
                                <li>
                                    <a><div class="accordion-title">02 &nbsp;   You have big dreams but lack of let you make them come true?    </div><div class="accordian-icon"><i class="bi bi-chevron-down"></i></div></a>
                                    <p>Authoritatively evisculate technically sound action items for 
                                    synergistic portals. Intrinsicly synthesize inexpensive experi
                                    ences rather than cross-unit .</p>
                                </li>
                                <li>
                                    <a><div class="accordion-title">03 &nbsp;  You want to live your best life but don’t know where to start?  </div><div class="accordian-icon"><i class="bi bi-chevron-down"></i></div></a>
                                    <p>Authoritatively evisculate technically sound action items for 
                                    synergistic portals. Intrinsicly synthesize inexpensive experi
                                    ences rather than cross-unit .</p>
                                </li>
                                <li>
                                    <a><div class="accordion-title">04 &nbsp;  Did you get any business consultant?  </div><div class="accordian-icon"><i class="bi bi-chevron-down"></i></div></a>
                                    <p>Authoritatively evisculate technically sound action items for 
                                    synergistic portals. Intrinsicly synthesize inexpensive experi
                                    ences rather than cross-unit .</p>
                                </li>
                                <li class="wow fadeInLeft animated">
                                    <a><div class="accordion-title">05 &nbsp;  Business facilisis erat id odio?   </div><div class="accordian-icon"><i class="bi bi-chevron-down"></i></div></a>
                                    <p>Authoritatively evisculate technically sound action items for 
                                    synergistic portals. Intrinsicly synthesize inexpensive experi
                                    ences rather than cross-unit .</p>
                                </li>
                                <li class="wow fadeInUp animated">
                                    <a><div class="accordion-title">06 &nbsp;  We best agency facilisis. </div><div class="accordian-icon"><i class="bi bi-chevron-down"></i></div></a>
                                    <p>Authoritatively evisculate technically sound action items for 
                                    synergistic portals. Intrinsicly synthesize inexpensive experi
                                    ences rather than cross-unit .</p>
                                </li>
				...
				<div class="col-xl-4 col-lg-4">
					<div class="service-sidebar">
						...
						<div class="sidebar-widget service-sidebar-single">
							<div class="service-sidebar-single-services wow fadeInUp animated">
								<div class="title">
									<h3>All Services</h3>
								</div>
								<ul>
									<li class="active"><a href="page-service-details.html">Cat Care <i class="fa fa-angle-right"></i></a></li>
									<li><a href="page-service-details.html">Cat Training <i class="fa fa-angle-right"></i></a></li>
									<li><a href="page-service-details.html">Cat Health<i class="fa fa-angle-right"></i></a></li>
									<li><a href="page-service-details.html">Cat Food <i class="fa fa-angle-right"></i></a></li>
								</ul>
							</div>
						</div>
						...
						<div class="sidebar-widget service-sidebar-single">
							<div class="service-sidebar-single-contact-box text-center wow fadeInUp animated">
								...
								<div class="title">
									<h2>Selling <br>Medical<br> Products</h2>
								</div>
						...
						<!--End Services Details Sidebar Single-->
                        <div class="sidebar-widget banner-widget wow fadeInUp animated">
                            <div class="widget-content">
                                <div class="shape"></div>
                                <div class="content-box">
                                    <div class="icon-box">
                                        <a href="index.html"><img src="assets/images/main-thumb/logo-four.png" alt=""></a>
                                    </div>
                                    <h3>Keep Smiling with a Fresh and Healthy Cat</h3>
						...
						<div class="sidebar-widget service-sidebar-single">
							<div class="service-sidebar-single-btn wow fadeInUp"
								...
								<a href="eror.html"><span class="fas fa-file-pdf"></span> download pdf file</a>
							</div>
						</div>
					</div>
				</div>
	...
	<!--==================================================-->
	<!-- End Cat Shop Service Details Section Here -->
	<!--==================================================-->
	...
	<footer class="footer-section">
				...
				<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".2s">
					<div class="footer-link">
						...
						<ul>
							...
							<li><a href="#"><i class="bi bi-arrow-right"></i>Bundle & Save</a></li>
							<li><a href="#"><i class="bi bi-arrow-right"></i>Online Gift Card</a></li>
							<li><a href="#"><i class="bi bi-arrow-right"></i>Discount</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".4s">
					<div class="footer-link">
						...
						<ul>
							...
							<li><a href="#"><i class="bi bi-arrow-right"></i>Order Tracking</a></li>
							<li><a href="#"><i class="bi bi-arrow-right"></i>Shoping Info</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".6s">
					<div class="footer-contact">
						...
						<div class="footer-contact-item">
							<i class="fas fa-phone"></i> <a href="#"> Phone: 800.123.4567</a>
						</div>
						<div class="footer-contact-item">
							<i class="fas fa-envelope"></i> <a href="#"> Email: example@yahoo.com</a>
						</div>
						<div class="footer-contact-item">
							<div><i class="fas fa-map-marker-alt"></i> </div><div><h6> A26BT5 Building, SilverC Street,
								London, England.</h6></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6 col-md-6">
						<div class="footer-bottom-desc wow fadeInLeft">
							<p>Copyright 2023 @ Unique-Theme. All rights reserved.</p>
						</div>
					</div>
					<div class="col-lg-6 col-md-6">
		...
		<div class="footer-shape">
			<div class="footer-shape1">
				<img src="assets/images/shape/footer-shape.png" alt="shape">
			</div>
			<div class="footer-shape2">
				<img src="assets/images/shape/footer-shape2.png" alt="shape">
			</div>
			<div class="footer-shape3">
				<img src="assets/images/shape/footer-shape3.png" alt="shape">
			</div>
			...
			<div class="footer-shape7">
				<img src="assets/images/shape/footer-shape_2.png" alt="shape">
			</div>
		</div>
	</footer>
	<!--==================================================-->
	...
	<div class="sidebar-menu-wrapper">
		<div class="cart_sidebar">
			...
			<div class="cart_items_list">
				<div class="cart_item">
					<div class="item_image">
						<img src="assets/images/main-thumb/collection-thumb.jpeg" alt="image_not_found">
					</div>
					<div class="item_content">
						<h4 class="item_title">
				...
				<div class="cart_item">
					<div class="item_image">
						<img src="assets/images/main-thumb/collection-thumb2.jpeg" alt="image_not_found">
					</div>
					<div class="item_content">
						<h4 class="item_title">
							Rorem ipsum dolor sit amet, sectetur adipisi cingey.
				...
				<div class="cart_item">
					<div class="item_image">
						<img src="assets/images/main-thumb/collection-thumb3.jpeg" alt="image_not_found">
					</div>
					<div class="item_content">
						<h4 class="item_title">
							Rorem ipsum dolor sit amet, sectetur adipisi cingey.
				...
				<div class="cart_item">
					<div class="item_image">
						<img src="assets/images/main-thumb/collection-thumb4.jpeg" alt="image_not_found">
					</div>
					<div class="item_content">
						<h4 class="item_title">
							Rorem ipsum dolor sit amet, sectetur adipisi cingey.
				...
				<div class="sidebar-textwidget">
					...
					<div class="sidebar-info-contents">
						<div class="content-inner">
							<div class="nav-logo">
								<a href="index-2.html"><img src="assets/images/main-thumb/cat-logo.png" alt="logo"></a>
							</div>
							<!-- widget search -->
								...
								<ul>
									<li>
										<div class="widget-gallery-thumb">
											<a href="shop-2.html"><img src="assets/images/main-thumb/collection-thumb8.jpeg" alt="thumb"></a>
										</div>
									</li>
									<li>
										<div class="widget-gallery-thumb">
											<a href="shop-2.html"><img src="assets/images/main-thumb/collection-thumb7.jpeg" alt="thumb"></a>
										</div>
									</li>
									<li>
										<div class="widget-gallery-thumb">
											<a href="shop-2.html"><img src="assets/images/main-thumb/collection-thumb3.jpeg" alt=""></a>
										</div>
									</li>
									<li>
										<div class="widget-gallery-thumb">
											<a href="shop-2.html"><img src="assets/images/main-thumb/collection-thumb4.jpeg" alt=""></a>
										</div>
									</li>
									<li>
										<div class="widget-gallery-thumb">
											<a href="shop-2.html"><img src="assets/images/main-thumb/collection-thumb5.jpeg" alt=""></a>
										</div>
									</li>
									<li>
										<div class="widget-gallery-thumb">
											<a href="shop-2.html"><img src="assets/images/main-thumb/collection-thumb6.jpeg" alt=""></a>
										</div>
									</li>
								</ul>
							</div>
